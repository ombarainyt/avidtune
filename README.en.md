...
<div align="center">
  <img src="https://github.com/cgens67/AvidTune/blob/master/fastlane/metadata/android/en-US/images/featureGraphic.png" alt="AvidTune Banner" width="100%"/>
  
  ### Advanced YouTube Music Client with Material Design 3 for Android
  
  [![Latest Release](https://img.shields.io/github/v/release/cgens67/AvidTune?style=flat-square&logo=github&color=0D1117&labelColor=161B22)](https://github.com/cgens67/AvidTune/releases)
  ...
  [![Translation Status](https://badges.crowdin.net/avidtune/localized.svg)](https://crowdin.com/project/avidtune)
...
> **Note**: AvidTune is an independent project and is not affiliated, sponsored, or endorsed by YouTube or Google.
...
3. Navigate and select the AvidTune directory
...
All participants in this project must adhere to our code of conduct that promotes an inclusive, respectful, and constructive environment. Please review the [complete Code of Conduct](https://github.com/cgens67/AvidTune/blob/master/CODE_OF_CONDUCT.md) before contributing.
...
1. **Issue Review**: Check [open issues](https://github.com/cgens67/AvidTune/issues) or create a new one describing the problem or feature
...
> **Development Guidelines**: Review our [contribution guidelines](https://github.com/cgens67/AvidTune/blob/master/CONTRIBUTING.md) for detailed information about development process, code standards, and workflow.

---

## Support the Project

If you find value in **AvidTune** and want to contribute to its continued development, consider making a donation. Your financial support allows us to:
...
> **Note**: Donations are completely optional. AvidTune will always be free and open-source, regardless of financial support received.
