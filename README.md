...
<div align="center">
  <img src="https://github.com/cgens67/AvidTune/blob/master/fastlane/metadata/android/en-US/images/featureGraphic.png" alt="Banner de AvidTune" width="100%"/>
  
  ### Cliente Avanzado de YouTube Music con Material Design 3 para Android
  
  [![Última Versión](https://img.shields.io/github/v/release/cgens67/AvidTune?style=flat-square&logo=github&color=0D1117&labelColor=161B22)](https://github.com/cgens67/AvidTune/releases)
  [![Licencia](https://img.shields.io/github/license/cgens67/AvidTune?style=flat-square&logo=gnu&color=2B3137&labelColor=161B22)](https://github.com/cgens67/AvidTune/blob/main/LICENSE)
  [![Estado de Traducción](https://badges.crowdin.net/avidtune/localized.svg)](https://crowdin.com/project/avidtune)
  ...
  [![Estrellas](https://img.shields.io/github/stars/cgens67/AvidTune?style=flat-square&logo=github&color=yellow&labelColor=161B22)](https://github.com/cgens67/AvidTune/stargazers)
...
> **Nota**: AvidTune es un proyecto independiente y no está afiliado, patrocinado ni respaldado por YouTube o Google.
...
[![Documentación](https://img.shields.io/badge/Documentación-GitBook-4285F4?style=for-the-badge&logo=gitbook&logoColor=white)](https://avidtune.gitbook.io/)
...
1. Navega a la sección de [Releases](https://github.com/cgens67/AvidTune/releases) en GitHub
...
1. Visita el [sitio web oficial de AvidTune](https://avidtune.netlify.app/)
...
3. Navega y selecciona el directorio de AvidTune
...
Todos los participantes en este proyecto deben adherirse a nuestro código de conducta que promueve un entorno inclusivo, respetuoso y constructivo. Por favor, revisa el [Código de Conducta completo](https://github.com/cgens67/AvidTune/blob/master/CODE_OF_CONDUCT.md) antes de contribuir.

### Traducción

Ayuda a traducir AvidTune a tu idioma o mejorar las traducciones existentes:
...
[![Chat de Telegram](https://img.shields.io/badge/Telegram-Chat-2CA5E0?style=for-the-badge&logo=telegram&logoColor=white)](https://t.me/AvidTune_chat)
[![Actualizaciones de Telegram](https://img.shields.io/badge/Telegram-Actualizaciones-2CA5E0?style=for-the-badge&logo=telegram&logoColor=white)](https://t.me/avidtune_updates)

</div>

### Flujo de Trabajo de Desarrollo

1. **Revisión de Issues**: Verifica [issues abiertas](https://github.com/cgens67/AvidTune/issues) o crea una nueva describiendo el problema o característica
...
> **Directrices de Desarrollo**: Revisa nuestras [directrices de contribución](https://github.com/cgens67/AvidTune/blob/master/CONTRIBUTING.md) para información detallada sobre el proceso de desarrollo, estándares de código y flujo de trabajo.

---

## Apoya el Proyecto

Si encuentras valor en **AvidTune** y quieres contribuir a su desarrollo continuo, considera hacer una donación. Tu apoyo financiero nos permite:
...
> **Nota**: Las donaciones son completamente opcionales. AvidTune siempre será gratuito y de código abierto, independientemente del apoyo financiero recibido.
...
- **Traductores de la comunidad** - Haciendo AvidTune accesible mundialmente
...
Este programa se distribuye con la esperanza de que sea útil, pero **SIN NINGUNA GARANTÍA**; ni siquiera la garantía implícita de COMERCIABILIDAD o IDONEIDAD PARA UN PROPÓSITO PARTICULAR. Consulta la [Licencia Pública General GNU](https://github.com/cgens67/AvidTune/blob/main/LICENSE) para más detalles.
...
<div align="center">
  ...
  <p>Desarrollado con pasión por <a href="https://github.com/cgens67">Arturo Cervantes</a></p>
