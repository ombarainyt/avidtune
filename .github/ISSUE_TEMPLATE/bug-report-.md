---
name: Bug Report
about: Report a bug found in AvidTune to help us improve the application
...
```
**How to capture logs:**
- Use `adb logcat | grep -i avidtune` for filtered logs
...
- [ ] I have tested on the latest version of AvidTune
